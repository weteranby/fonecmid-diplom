...
КонецПроцедуры
	...
	//
	//Создаю Представление сотрудника ФИО + Категория (Из регистра Сведений)
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	КатегорияТекст = ВКМ_СерверныеФункции.ПолучитьТекстКатегорииСотрудника(Данные.Ссылка);
	Представление = Строка(Данные.Наименование) + КатегорияТекст;
